...
from data_length_1 import ConceptExampleGenerator
...
class Config:
    ...
    concepts_file: str = "../inputs/concepts_exp.json"
...
def main():
    ...
    config = Config(
        ...
        examples_dir="../experiment_examples/period_075", # change path here for Chi Chi's trials
        probes_dir="../experiment_probes/p75", # changed path for Chi Chi's trials,
