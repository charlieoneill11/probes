...
pip list | grep -E "circuitsvis|datasets|einops|nnsight|pandas|plotly|tqdm|zstandard|wandb|umap-learn|llvmlite|pytest|tokenizers|transformers|transformer-lens"